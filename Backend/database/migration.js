...
const db = new sqlite3.Database('./Backend/database/database.db', (err) => {
    if (err) {
        ...
        db.serialize(() => {
            ...
            db.run(`INSERT INTO projects (name) VALUES
                ...
                db.run(`INSERT INTO tasks (title, description, date_of_creation, status, project_id) VALUES
                        ('Task 1', 'Task 1 description', '6-30-2024', 'In Progress', 1),
                        ('Task 2', 'Task 2 description', '6-15-2024', 'Pending', 1),
                        ('Task 3', 'Task 3 description', '6-23-2024', 'Completed', 2),
                        ('Task 4', 'Task 4 description', '6-30-2024', 'Pending', 2),
                        ('Task 5', 'Task 5 description', '6-1-2024', 'In Progress', 3),
                        ('Task 6', 'Task 6 description', '6-3-2024', 'Pending', 3),
                        ('Task 7', 'Task 7 description', '6-9-2024', 'Completed', 3)`, (err) => {
                    if (err) {
